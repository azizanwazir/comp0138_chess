...
def create_nodelist_separate(csv_filename_list, json_filename):
    ...
    # merged_csv = pd.concat(merged_csv)
        ...
        day_count, date_dict = get_date_id_dict(csv_f)
        ...
        for player in node_dict:
            ...
            perspective_1 = [start_elo, end_elo, max_elo, min_elo, avg_elo] + win_stats + loss_stats + draw_stats + [win_count, loss_count, draw_count, max_win_streak, max_lose_streak]
            ...
            avg_days_between_sessions = avg_time_between_sessions_f(daily_game_count)
...
create_nodelist_separate(['lichess_db_standard_rated_2014-01_cut.csv'], '2014_nodes.txt')
